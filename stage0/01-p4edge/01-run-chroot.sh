...
echo 'deb [signed-by=/usr/share/keyrings/p4lang-archive-keyring.gpg] http://download.opensuse.org/repositories/home:/p4lang/Debian_11/ /' | tee /etc/apt/sources.list.d/p4lang.list
curl -fsSL https://download.opensuse.org/repositories/home:p4lang/Debian_11/Release.key | gpg --dearmor > /usr/share/keyrings/p4lang-archive-keyring.gpg
