...
install -m 644 files/p4edge.conf "${ROOTFS_DIR}/etc/dnsmasq.d/"
...
install -m 755 files/p4edge-setup "${ROOTFS_DIR}/usr/sbin/"
install -m 644 files/p4edge-setup.service "${ROOTFS_DIR}/lib/systemd/system/"
